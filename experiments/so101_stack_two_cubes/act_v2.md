...
```bash
bash experiments/so101_stack_two_cubes/record_act_v2_data.sh --status
bash experiments/so101_stack_two_cubes/record_act_v2_data.sh
```
...
```bash
bash experiments/so101_stack_two_cubes/discard_last_act_v2_episode.sh 12
```
...
```bash
bash experiments/so101_stack_two_cubes/prepare_act_v2_subsets.sh
```
...
```bash
bash experiments/so101_stack_two_cubes/train_act_v2.sh \
