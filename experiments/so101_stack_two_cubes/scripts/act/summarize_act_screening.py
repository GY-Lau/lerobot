...
# Sibling helpers now live in ../common; put that directory on sys.path.
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--trials-path", type=Path, default=experiment_dir / "results" / "trials.csv")
    parser.add_argument("--latency-dir", type=Path, default=repo_root / "outputs" / "eval_latency")
    parser.add_argument(
        "--output", type=Path, default=experiment_dir / "results" / "act_physical_screening.csv"
    )
