...
positions_csv="${ACT_V2_POSITIONS_CSV:-$script_dir/act_v2_start_positions.csv}"
manifest="${ACT_V2_MANIFEST:-$script_dir/act_v2_subsets.json}"

analyze_cmd=(
  "$python_bin" "$script_dir/analyze_cube_placements.py"
  "--dataset-root=$dataset_root"
  "--repo-id=$dataset_repo"
  "--output=$positions_csv"
)
validate_cmd=(
  "$python_bin" "$script_dir/validate_act_v2_positions.py"
